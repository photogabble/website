...
tags:
    ...
    - linux
    - wordpress
cover_image: /assets/img/fail2ban-regex.png
---

![WordPress Jetpack malicious login attempts](/assets/img/wordpress-jetpack-malicious-login-attempts.png "Wordpress Jetpack malicious login attempts")
...
![fail2ban-regex output](/assets/img/fail2ban-regex.png "fail2ban-regex output")
